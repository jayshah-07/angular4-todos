...
describe('TodoDataService', () => {
  ...
  describe('#save(todo)', ()=>{
    it('should automatically assign an increment id',inject([TodoDataService], (service: TodoDataService) => {
      let todo1 = new Todo({ title: 'Hello 1', complete: false});
      let todo2 = new Todo({ title: 'Hello 2', complete: true});
      service.addTodo(todo1);
      service.addTodo(todo2);
  ...
  describe('#deleteTodoById(id)', () => {
    ...
    describe('#updateTodoById(id, values)', ()=> {
      ...
      describe('#toggleTodoComplete(todo)', ()=>{
        it('should return the updated todo list with the inverse complete status', inject([TodoDataService], (service: TodoDataService) =>{
          let todo = new Todo({
            title:"Hello jay",
            complete: false
          });
